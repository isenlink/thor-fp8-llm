...
docs/
  ...
  08-fp8-fastpath-server/ **FP8 权重侧快路服务端**（自研非 tcgen05 路线）：完整源码补丁集（pin 72797e89 + 12 补丁 + 4 新增 FP8 源文件）、交叉编译配方、启动脚本、128K/200K 实测读数、9 t/s 排障清单、精度自检（**预编译二进制走网盘分发，见该目录 README**）
